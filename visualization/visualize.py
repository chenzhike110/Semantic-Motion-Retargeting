...
def mesh_visualize(
    ...
    bpy.ops.object.text_add(enter_editmode=False, align='WORLD', location=(x_bias, y_bias, z_bias+2.2), rotation=(1.57, 0, 1.57))
    ...
    load_fbx(input_fbx)
    bpy.context.object.rotation_euler[2] = 1.5707
...
def main():
    ...
    clean_scene()
    bvh_list = args.bvh_list
    fbx_list = args.fbx_list
    assert len(bvh_list) == len(fbx_list)
    ...
    #     "./bvh_files/XBot_to_AJ_Praying.bvh",
    #     y_bias=0.0,
    #     collection_name='Copy Mesh1',
    #     source_format='h36m',
    # )
    ...
    # )
    # mesh_visualize(
    #     args.dcopy_fbx_file3,
    #     args.dcopy_result3_bvh,
    #     y_bias=2.0,
    #     collection_name='Copy Mesh2',
    #     source_format='h36m',
    # )
    # mesh_visualize(
    #     args.dcopy_fbx_file4,
    #     args.dcopy_result4_bvh,
    #     y_bias=2.0,
    #     collection_name='Copy Mesh2',
    #     source_format='h36m',
    # )
