...
class Blip2T5Instruct(Blip2Base):
    ...
    def extract_semantics(self, samples):
        # print('-----------------')
        ...
        with self.maybe_autocast(dtype=torch.float32):
            ...
            inputs_embeds = torch.cat([inputs_t5.to(image.device), inputs_embeds.to(image.device)], dim=1)
            ...
            return query_output, outputs, image_embeds
